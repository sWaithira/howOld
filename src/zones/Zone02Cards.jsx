...
const THEMES = [
  { id: "navy", label: "Navy", color: "#d4af37", bg: "#0a0e1a" },
  { id: "journal", label: "Journal", color: "#c8a050", bg: "#0e0b08" },
  { id: "cosmic", label: "Cosmic", color: "#a078dc", bg: "#0c0a12" },
];
...
const ROADMAP = [
  {
    version: "v3.0",
    status: "live",
    label: "Card Discovery Experience",
    items: [
      "8 free insight cards",
      "Three themes",
      "PWA installable",
      "Shareable cards",
    ],
...
export default function Zone02Cards({ age }) {
  ...
  const cards = getCards(age);
  if (!age || cards.length === 0) return null;
      ...
      >
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "radial-gradient(ellipse at 50% 20%, var(--bg3) 0%, var(--bg) 60%)",
            pointerEvents: "none",
          }}
        />
        ...
        <div style={{ maxWidth: "680px", margin: "0 auto" }}>
          ...
          >
            {[
              ...
              {
                label: "Total Hours",
                value: age.totalHours.toLocaleString(),
                accent: "var(--text2)",
              },
              { label: "Days", value: age.days, accent: "var(--text2)" },
              {
                label: "Total Weeks",
                value: age.totalWeeks.toLocaleString(),
                accent: "var(--text2)",
              },
              {
                label: "Total Minutes",
                value: age.totalMinutes.toLocaleString(),
                accent: "var(--text3)",
              },
              {
                label: "Seconds ⚡",
          ...
          >
            {[
              ...
              {
                label: "Birth Type",
                value: age.isWeekend ? "Weekend" : "Weekday",
              },
              {
                label: "Next Birthday",
              ...
              {ROADMAP.map((step, i) => (
                <div
                  ...
                  style={{
                    padding: "20px 24px",
                    background:
                      step.status === "live" ? `var(--surface)` : "transparent",
                    border:
                      step.status === "live"
            ...
            >
              ...
              >
                {[
                  {
                    label: "GitHub",
                    href: "https://github.com/sWaithira/howOld",
                  },
                  {
                    label: "Portfolio",
